...
const CommonTaxIssues: React.FC = () => {
  return (
    <div className="container mx-auto py-6 max-w-7xl">
      <h1 className="text-3xl font-bold mb-2">Common Tax Issues & Solutions</h1>
      <p className="text-gray-600 mb-6">
        Tools and guidance for the most frequently reported HMRC challenges
      </p>

      <Tabs defaultValue="mistakes" className="space-y-6">
        <TabsList className="grid grid-cols-5 mb-4 w-full max-w-4xl">
        ...
        <TabsContent value="mistakes">
          <p className="text-gray-700 mb-5 max-w-4xl">
      ...
      <div className="mt-10 p-4 bg-blue-50 rounded-lg border border-blue-200 max-w-2xl">
        <h3 className="font-bold text-blue-900 mb-2">Why These Tools Exist</h3>
